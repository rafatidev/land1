  ...
  if (items.length === 0 && !isSubmitting) {
      return (
          <div className="text-center p-10 bg-gray-800 rounded-lg">
              ...
              <button onClick={() => router.push('/')} className="mt-4 bg-yellow-500 text-gray-900 font-bold py-2 px-4 rounded-lg hover:bg-yellow-400 transition-colors">بازگشت به فروشگاه</button>
          </div>
      )
  }
