  ...
  if (totalItems() === 0) {
    return (
      <div className="text-center bg-gray-800 p-10 rounded-lg">
        ...
        <Link to="/" className="bg-yellow-500 text-gray-900 font-bold py-2 px-6 rounded-lg hover:bg-yellow-400 transition-colors">
          بازگشت به فروشگاه
        </Link>
      </div>
    );
    ...
    <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-xl">
      ...
      <div className="mt-8 flex justify-end">
        <div className="w-full md:w-1/3">
          ...
          <Link to="/checkout" className="block w-full text-center bg-yellow-500 text-gray-900 font-bold py-3 px-6 rounded-lg text-lg hover:bg-yellow-400 transition-colors">
            ادامه فرآیند خرید
          </Link>
        </div>
      </div>
